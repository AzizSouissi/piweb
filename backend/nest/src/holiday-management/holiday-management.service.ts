...
export class HolidayManagementService {
  ...
  async createHoliday(createHolidayDto: CreateHolidayManagementDto): Promise<Holiday> {
  ...
  async findAll():Promise<Holiday[]> {
    ...
    async update(id: string, updateHolidayManagementDto: UpdateHolidayManagementDto): Promise<Holiday | any> {
      try {
